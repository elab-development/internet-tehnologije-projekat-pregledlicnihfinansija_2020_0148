...
const HealthAndWellness = () => {
  const {
    ...
    { id: 2, amount: 30.0, description: "Fitpass", date: "2024-04-08" },
  ]);

  return (
    <div className="body-trans">
      <div className="img-container-trans">
        <img src="/images/healthandwellness.jpg" alt="Health and wellness" />
      </div>
      <div className="container-trans">
        <div className="title-trans">
          <h2>Transactions for Health and wellness</h2>
