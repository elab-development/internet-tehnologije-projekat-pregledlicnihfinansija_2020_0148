...
const Shopping = () => {
  const {
    ...
    { id: 1, amount: 150.0, description: "Shoes", date: "2024-04-09" },
    { id: 2, amount: 1300.0, description: "Laptop", date: "2024-04-08" },
  ]);

  return (
    <div className="body-trans">
      <div className="img-container-trans">
        <img src="/images/shopping.jpeg" alt="Shopping" />
      </div>
      <div className="container-trans">
        <div className="title-trans">
          <h2>Transactions for Shopping</h2>
